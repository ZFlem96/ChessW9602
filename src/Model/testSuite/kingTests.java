...
public class kingTests {
    ...
    public void up() {
        ...
        king king = new king(3, 3, WHITE, newGame.chess, newGame.chess.player1);
        newGame.chess.board[3][3] = king;
        newGame.movePieceTo(king, 4, 3);

        assertEquals(king, newGame.chess.board[4][3]);
    }
    ...
    public void upRight() {
        ...
        Pieces king = new king(3, 3, WHITE, newGame.chess, newGame.chess.player1);
        newGame.chess.board[3][3] = king;
        newGame.movePieceTo(king, 4, 4);

        assertEquals(king, newGame.chess.board[4][4]);
    }
    ...
    public void upLeft() {
        ...
        Pieces king = new king(3, 3, WHITE, newGame.chess, newGame.chess.player1);
        newGame.chess.board[3][3] = king;
        newGame.movePieceTo(king, 4, 2);

        assertEquals(king, newGame.chess.board[4][2]);
    }
